...
INSERT INTO items (name,description,cal,category_id,image_url,price) VALUES ('mushroom soup','basic roux is thinned with cream or milk and then mushrooms and/or mushroom broth are added',39,2,'images/mushroom.jpg',3.99);
INSERT INTO items (name,description,cal,category_id,image_url,price) VALUES ('lentil soup','is a soup based on lentils; it may be vegetarian or include meat, and may use brown, red, yellow, green or black lentils',56,2,'images/lentil.jpg',4.99);

INSERT INTO items (name,description,cal,category_id,image_url,price) VALUES ('caeser salad',' romaine lettuce and croutons dressed with lemon juice, olive oil, egg, Worcestershire sauce, anchovies, garlic, Dijon mustard, Parmesan cheese, and black pepper',44,3,'images/Caeser.jpg',5.99);
